...
binned_format_file_name = 'Binned_data_pulvinar_both_250ms_bins_50ms_sampled.mat';
...
ds = basic_DS(binned_format_file_name, specific_label_name_to_use, num_cv_splits); % make max cv splits
...
DECODING_RESULTS = the_cross_validator.run_cv_decoding_singleTrial;
