...
%         SPKSEL.nocatch_nodisap = SPKSEL.nocatch_nodisap(:, chans2take, :);
        ...
        for currChanId = chanId
            ...
            raster_data = [physDisap'; physNoDisap'];
            ...
            raster_labels.disap_nodisap = [physDisap_labels; physNoDisap_labels];
            
            savename = ['spk_' areaNames{areaNum} '_' info_id '_ch' num2str(currChan) '_physical.mat'];
            
            disp(['Saving ' savename])
            fprintf('\n')
            raster_site_info = [];
            save(['.\physical_condition_dataset\' savename], 'raster_data', 'raster_labels', 'raster_site_info')
            clear physDisap physNoDisap raster_data physDisap_labels ...
                physNoDisap_labels raster_labels
        end
        clear SInf
    end
