...
% % create binned data
% raster_file_directory_name = '.\all_condition_dataset';
% save_prefix_name = '.\all_condition_dataset\Binned_all_allAreas_data';
% bin_width = 150;
% step_size = 50;
% 
...
binned_format_file_name = './all_condition_dataset/Binned_all_allAreas_data_150ms_bins_50ms_sampled.mat';
...
the_cross_validator.num_resample_runs = 1;
